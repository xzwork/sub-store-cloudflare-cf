...
2. Review the pre-created `Daily` Collection; create another only when needed. The vendored `aethersailor-standard` template is the default; each Aethersailor variant and huLter remain separate choices.
